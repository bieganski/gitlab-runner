...
One can tell Docker which DNS server to use by using the `dns` configuration in the `[runners.docker]` section of [the Runner's config.toml](../configuration/advanced-configuration.html#the-runnersdocker-section).
